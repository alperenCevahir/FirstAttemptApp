...
namespace FirstAttempt.Service.Validation
{
    public class ProductDtoValidator : AbstractValidator<ProductDto>
    {
        public ProductDtoValidator()
        {
            ...
            //Bunu kapattık çünkü dropdown list yapıyoruz onu da direkt biz dolduruyoruz
            //(x => x.CategoryId).InclusiveBetween(1, int.MaxValue).WithMessage("{PropertyName} must be greater than 0");
